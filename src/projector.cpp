...
namespace L2PG {
	...
	********************/
	...
	std::pair<bool,std::map<IdxSet, GridPt>> Projector::Impl::get_surrounding_2(std::vector<double> abcissas) const {
	...
	********************/
	...
	std::pair<bool,std::map<IdxSet, GridPt>> Projector::get_surrounding_2(std::vector<double> abcissas) const {
		return _impl->get_surrounding_2(abcissas);
	};
